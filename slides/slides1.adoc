...
[NOTE.speaker]
--
 There are two delivery modes: nonpersistent and persistent.
--

== Transactions and redelivery
image:{images}/jms-transaction-redelivery.png[]
...
[NOTE.speaker]
--
 If session is set as transacted then acknowledgeMode is ignored
--
